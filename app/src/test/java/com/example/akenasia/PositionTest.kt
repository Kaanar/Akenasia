...
internal class PositionTest {
    ...
    fun test_calcul_distance2() {
        assertEquals(216.9404896911061, pos.calcul_distance(48.780791, 2.194554, 48.780860991009554, 2.1975147547196374))
    ...
    fun test_calcul_distance3() {
        assertEquals(11245.397120655323, pos.calcul_distance(48.805756910426176, 2.16831734680431, 48.90217564349271, 2.215013203244392))
    ...
    fun test_calcul_distance4() {
        assertEquals(9710227.890821466, pos.calcul_distance(48.90231689667814, 2.214946021579729, 35.68433600366023, 139.75309056001143))
