...
* Les lieux, représentés par des marqueurs, sont désormais différenciés par leur couleur. Les items récupérables différent en fonction de la couleur du marqueur.
